...
void ATitleButton::BeginPlay()
{
	...
	TitleText->SetFont("CandyCrush", 20.0f, TColor<unsigned char>::BLACK, FW1_CENTER);
	...
	TitleText->SetHoverEvent([this] {
		...
		TitleText->SetFont("CandyCrush", 25.0f, TColor<unsigned char>::BLACK, FW1_CENTER);
		TitleText->SetText("PLAY");
